  ...
  detailContainer: {
    ...
    "& img": {
      [theme.breakpoints.down(1000)]: {
        //similar to mediaquery (maxwidth:1000px)
        order: 0,
        height: "42vw"
      }
    }
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ background: "#18b5c6", color: "white" }}
      >
        ...
        <div className={workingDetails}>
          ...
          <ul className="fa-ul">
            <li>
              <i className="fa-li fa fa-check-square" /> Register an account as
              a Job Seeker.
            </li>
            <li>
              <i className="fa-li fa fa-check-square" /> Login with the account.{" "}
            </li>
            <li>
              <i className="fa-li fa fa-check-square" /> Start searching for
              jobs.{" "}
            </li>
          </ul>
        </div>
      ...
      <section className={detailContainer} style={{ background: "#8dd9e0" }}>
        <div className={workingDetails}>
          ...
          <ul className="fa-ul">
            ...
            <li>
              <i className="fa-li fa fa-check-square" /> Start posting jobs to
              recruit job seekers.{" "}
            </li>
          </ul>
        </div>
